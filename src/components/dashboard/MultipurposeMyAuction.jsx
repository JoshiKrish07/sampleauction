                ...
                <div className="tab-content" id="pills-tabContent">
                  ...
                  >
                    <div className="row g-4">
                      ...
                      !error ? (
                        Object.keys(userData).slice(indexOfFirstItem, indexOfLastItem)
                        .map((index) => {
                          return (
                            <div className="col-xl-4 col-lg-6" key={userData[index]?.bid_id}>
                              <div className="auction-card style-3">
                                ...
                                <div className="auction-card-content">
                                  <h6>
                                    <Link href={`/auction-details/${userData[index].lot_id}`}>
